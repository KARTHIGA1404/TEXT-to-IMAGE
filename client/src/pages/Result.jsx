...
const Result = () => {
    ...
    const [image, setImage]=useState(assets.hi1)
...
/>
    ...
    <div className='flex w-full max-w-xl bg-neutral-500 text-white text-sm p-0.5 mt-10 rounded-full'>
      ...
      type="text" placeholder='Imagine it. Describe it here.' className='flex-1 bg-transparent outline-none ml-8 max-sm:w-20 placeholder-color'/>
